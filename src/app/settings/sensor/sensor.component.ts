...
export class SensorComponent implements OnInit {
  ...
  Update() {
    ...
    this.http
      .post('http://192.168.0.126:3000/api/updateSensor', this.editData)
      .subscribe(
        (response: any) => {
      ...
      if(this.editData.param_name.includes('current')){
        ...
        this.http.post('http://192.168.0.126:3000/api/updatebinss', {bins}).subscribe(
          (response:any)=>{
  ...
  getStationConfig() {
    this.http
      .get('http://192.168.0.126:3000/api/getStationConfig')
      .subscribe((data: any) => {
  ...
  updateHomeConfig(station: any) {
    ...
    this.http
      .put('http://192.168.0.126:3000/api/updateHomeConfig', payload)
      .subscribe({
        next: (res) => {
