...
index!:number;
 ...
 createStation() {
  ...
  this.http.post('http://192.168.0.6:3000/api/addStation', this.addStationData).subscribe(
    (response) => {
      this.getStation();
 ...
 updateStation() {
  ...
  this.http.post('http://192.168.0.6:3000/api/editStation', updatingStation).subscribe(
    (response) => {
