  ...
  getStation(){
    this.http.get('http://localhost:3000/api/getStationConfig').subscribe(
      (response: any) => {
        ...
        this.Stations_list = response.map((item: { station_id: any; station_name: any; warning: any; danger: any; lat_dd: any; lon_dd: any; lat_deg: any; lat_min: any; lat_sec: any; lon_deg: any; lon_min: any; lon_sec: any; status: any; sensors: string; geo_format: any; created_at: any; image:any;}) => ({
