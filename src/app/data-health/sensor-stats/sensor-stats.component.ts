  ...
  private updateStatsFromApiData(): void {
    ...
    const parameterMapping: { [key: string]: { name: string; tabId: string } } =
      {
        ...
        'oceanography.wave.2': {
          name: 'Zero Crossing Period (Tzc)',
          tabId: '2',
        },
        'oceanography.wave.3': {
          name: 'Mean Zero Crossing Period (Tz)',
          tabId: '3',
        },
        ...
        'oceanography.wave.14': {
          name: 'Average Wave Height (Havg)',
          tabId: '14',
        },
        'oceanography.current.15': {
          name: 'Current Direction (Bin 1)',
          tabId: '15',
        },
        'oceanography.current.16': {
          name: 'Current Speed (Bin 1)',
          tabId: '16',
        },
        ...
        'meteorology.atmospheric.20': {
          name: 'Air Temperature (°C)',
          tabId: '20',
        },
        'meteorology.atmospheric.21': {
          name: 'Relative Humidity (%)',
          tabId: '21',
        },
        'meteorology.atmospheric.22': {
    ...
    this.stats = Object.entries(latestData.dataPresent)
      .filter(([key]) => {
        if (
          !this.hasMeteorology &&
          (key.startsWith('meteorology.wind.') ||
            key.startsWith('meteorology.atmospheric.'))
        ) {
          return false;
        }
