...
export class WaveComponent implements AfterViewInit {
  ...
  initOceanWaves() {
    ...
    const waves = [
      { amplitude: 10, length: 0.01, speed: 0.02, color: 'rgba(0, 110, 255, 0.38)' },
      { amplitude: 15, length: 0.015, speed: 0.015, color: 'rgba(0, 140, 255, 0.45)' },
      { amplitude: 20, length: 0.02, speed: 0.01, color: 'rgba(0, 179, 255, 0.57)' },
