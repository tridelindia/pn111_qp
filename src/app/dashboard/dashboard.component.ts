...
export class DashboardComponent implements OnInit{
  constructor(private map:MapService, private http:HttpClient, private layout:LayoutComponent){}
...
toggleMapoff(){
  ...
  this.showMap = false;
    ...
    fetchSensors() {
      ...
      const params = new HttpParams().set('fromDate', '2025-02-01T00:00:42.000Z').set('toDate', '2025-03-31T23:59:00.000Z').set('station_id', this.layout.selectedStationId);
